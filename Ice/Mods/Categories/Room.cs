...
public class Room : MonoBehaviourPunCallbacks
{
	...
	public static void GrabAllIDs()
	{
		...
		string text = Path.Combine(Variables.folderName, "Grabbed_IDs_By_Ice.txt");
		File.WriteAllText(text, stringBuilder.ToString());
