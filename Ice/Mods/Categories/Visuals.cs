...
public class Visuals
{
	...
	public static GameObject iceCamera;
	...
	public static void TrippyMonkes(bool enable)
	{
		...
		else
		{
			...
			Material val = AssetHandler.LoadMaterial("Ice.Resources.acidtrip", "AcidTrip");
	...
	public static void Freecam()
	{
		...
		else if ((UnityEngine.Object)(object)iceCamera == (UnityEngine.Object)null)
		{
			iceCamera = new GameObject("Ice_Cam");
			iceCamera.transform.position = ((Component)Variables.taggerInstance.headCollider).transform.position;
			Camera val = iceCamera.GetComponent<Camera>() ?? iceCamera.AddComponent<Camera>();
			...
			Transform transform = iceCamera.transform;
			transform.position += CameraVelocity * Time.unscaledDeltaTime;
			iceCamera.transform.rotation = ((Component)Variables.taggerInstance.headCollider).transform.rotation;
		}
		else
		{
			Camera val = iceCamera.GetComponent<Camera>() ?? iceCamera.AddComponent<Camera>();
			...
			val6 = val7;
			CameraVelocity = Vector3.Lerp(CameraVelocity, val6, 0.12875f);
			Transform transform2 = iceCamera.transform;
	...
	public static void DrunkCam()
	{
		...
		else if ((UnityEngine.Object)(object)iceCamera == (UnityEngine.Object)null)
		{
			...
			val.cameraType = (CameraType)1;
			iceCamera.transform.position = ((Component)Variables.taggerInstance.headCollider).transform.position;
			iceCamera.transform.rotation = ((Component)Variables.taggerInstance.headCollider).transform.rotation * Quaternion.Euler(Mathf.Sin(Time.time) * num, Mathf.Cos(Time.time * 0.7f) * num, Mathf.Sin(Time.time * 1.3f) * num);
		}
		else
		{
			float num = 15f;
	...
	public static void OrbitCam()
	{
		...
		else if ((UnityEngine.Object)(object)iceCamera == (UnityEngine.Object)null)
		{
			...
			iceCamera.transform.position = ((Component)Variables.taggerInstance.bodyCollider).transform.position + val2;
			iceCamera.transform.LookAt(((Component)Variables.taggerInstance.headCollider).transform.position);
		}
		else
		{
			Camera val = iceCamera.GetComponent<Camera>() ?? iceCamera.AddComponent<Camera>();
	...
	public static void DisableAmbience(bool enable)
	{
		...
		foreach (AudioSource val in array)
		{
			...
			if (((UnityEngine.Object)gameObject).name.StartsWith("Ice", StringComparison.OrdinalIgnoreCase) || !val.loop || val.spatialBlend < 0.5f)
			{
				continue;
			}
	...
	public static void FPSBoost(bool enable)
	{
		if (enable != lastState)
		{
			...
			if (enable)
			{
				Screen.SetResolution(IceUI.originalWidth / 6, IceUI.originalHeight / 6, true);
			...
			{
				Screen.SetResolution(IceUI.originalWidth, IceUI.originalHeight, true);
	...
	public static void SpectateGun()
	{
		...
		{
			if ((UnityEngine.Object)(object)iceCamera == (UnityEngine.Object)null)
			{
				iceCamera = new GameObject("Ice_Cam");
				iceCamera.transform.position = ((Component)Variables.taggerInstance.headCollider).transform.position;
				Camera val = iceCamera.GetComponent<Camera>() ?? iceCamera.AddComponent<Camera>();
				val.nearClipPlane = 0.01f;
				val.cameraType = (CameraType)1;
				iceCamera.transform.position = GunLib.lockedTargetRig.bodyTransform.TransformPoint(new Vector3(0f, 0.8f, -1.5f));
				iceCamera.transform.rotation = GunLib.lockedTargetRig.headMesh.transform.rotation;
			}
			else
			{
				Camera val = iceCamera.GetComponent<Camera>() ?? iceCamera.AddComponent<Camera>();
	...
	public static void DisableIceCamera()
	{
		InputHandler.isOn = false;
		if ((UnityEngine.Object)(object)iceCamera != (UnityEngine.Object)null)
		{
			UnityEngine.Object.Destroy((UnityEngine.Object)(object)iceCamera.GetComponent<Camera>());
			UnityEngine.Object.Destroy((UnityEngine.Object)(object)iceCamera);
			iceCamera = null;
		}
	}
	...
	public static void VrThirdPersonInFront()
	{
		...
		else if ((UnityEngine.Object)(object)iceCamera == (UnityEngine.Object)null)
		{
			...
			val.nearClipPlane = 0.01f;
			val.cameraType = (CameraType)1;
			iceCamera.transform.position = ((Component)Variables.taggerInstance.headCollider).transform.position + ((Component)Variables.taggerInstance.headCollider).transform.forward * 0.8f;
			iceCamera.transform.LookAt(((Component)Variables.taggerInstance.headCollider).transform.position);
		}
		else
		{
	...
	public static void UpsideDownCam()
	{
		...
		else if ((UnityEngine.Object)(object)iceCamera == (UnityEngine.Object)null)
		{
			...
			val.cameraType = (CameraType)1;
			iceCamera.transform.position = ((Component)Variables.taggerInstance.headCollider).transform.position;
			iceCamera.transform.rotation = ((Component)Variables.taggerInstance.headCollider).transform.rotation * Quaternion.Euler(0f, 0f, 180f);
		}
		else
		{
			Camera val = iceCamera.GetComponent<Camera>() ?? iceCamera.AddComponent<Camera>();
	...
	public static void VrThirdPerson()
	{
		...
		else if ((UnityEngine.Object)(object)iceCamera == (UnityEngine.Object)null)
		{
			...
			val.nearClipPlane = 0.01f;
			val.cameraType = (CameraType)1;
			iceCamera.transform.position = ((Component)Variables.taggerInstance.bodyCollider).transform.TransformPoint(new Vector3(0f, 0.8f, -1.5f));
			iceCamera.transform.rotation = ((Component)Variables.taggerInstance.headCollider).transform.rotation;
		}
		else
		{
