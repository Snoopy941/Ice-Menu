...
public class Settings
{
	...
	public static ColorMode TitleMode = ColorMode.Solid;
	...
	private static int menuSizeIndex = 3;

	public static string MenuSizeDescription = "Large";
	...
	private static int roundnessIndex = 2;

	public static float MenuRoundness = 0.5f;

	public static string RoundnessDescription = "Medium";
	...
	public static AccentStripType CurrentAccentStripType = AccentStripType.Off;

	private static readonly string[] AccentStripTypeNames = new string[3] { "Off", "Top", "Both" };

	private static int accentStripTypeIndex = 0;

	public static string AccentStripTypeDescription = "Off";
	...
	private static int backgroundColorIndex = 56;

	private static int backgroundColor2Index = 57;

	public static Color32 BackgroundColor = new Color32((byte)25, (byte)25, (byte)112, byte.MaxValue);

	public static Color32 BackgroundColor2 = new Color32((byte)65, (byte)105, (byte)225, byte.MaxValue);

	public static string BackgroundColorDescription = "Midnight Blue";

	public static string BackgroundColor2Description = "Royal Blue";

	public static ButtonHandler.Button adjustButtonColorButton;

	public static ButtonHandler.Button adjustButtonColor2Button;

	private static int buttonColorIndex = 51;

	private static int buttonColor2Index = 54;

	public static Color32 ButtonColor = new Color32((byte)30, (byte)144, byte.MaxValue, byte.MaxValue);

	public static Color32 ButtonColor2 = new Color32((byte)70, (byte)130, (byte)180, byte.MaxValue);

	public static string ButtonColorDescription = "Dodger Blue";

	public static string ButtonColor2Description = "Steel Blue";
	...
	private static int enabledButtonColorIndex = 53;

	private static int enabledButtonColor2Index = 52;

	public static Color32 EnabledButtonColor = new Color32((byte)135, (byte)206, (byte)235, byte.MaxValue);

	public static Color32 EnabledButtonColor2 = new Color32((byte)0, (byte)191, byte.MaxValue, byte.MaxValue);

	public static string EnabledButtonColorDescription = "Sky Blue";

	public static string EnabledButtonColor2Description = "Deep Sky Blue";
	...
	private static int opacityIndex = 4;

	public static float MenuOpacity = 0.55f;

	public static string OpacityDescription = "High";
