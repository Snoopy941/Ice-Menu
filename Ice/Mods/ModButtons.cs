...
public class ModButtons
{
	private static ButtonHandler.Button[] _buttons = new ButtonHandler.Button[]
	{
		...
		new ButtonHandler.Button("Open Ice Folder", Category.Settings, isToggle: false, isActive: false, delegate
		{
		...
		new ButtonHandler.Button("Float Gun (Blaster)", Category.Gamemode, isToggle: true, isActive: false, Ice.Mods.Categories.SuperInfection.GunFlingTest),
		new ButtonHandler.Button("Complete Quests", Category.Gamemode, isToggle: false, isActive: false, Ice.Mods.Categories.SuperInfection.CompleteAllQuests),
		new ButtonHandler.Button("Complete & Claim Quests", Category.Gamemode, isToggle: false, isActive: false, delegate
		{
			Ice.Mods.Categories.SuperInfection.CompleteAllQuestsAndClaimPoints(SIPlayer.LocalPlayer);
		}),
		new ButtonHandler.Button("Add TechPoints", Category.Gamemode, isToggle: false, isActive: false, delegate
		{
			Ice.Mods.Categories.SuperInfection.AddResources((SIResource.ResourceType)0, 10);
		}),
		new ButtonHandler.Button("Give All Resources", Category.Gamemode, isToggle: false, isActive: false, delegate
		{
			Ice.Mods.Categories.SuperInfection.GiveAllResourcesToMax(SIPlayer.LocalPlayer);
		}),
		new ButtonHandler.Button("Unlock All Gadgets", Category.Gamemode, isToggle: false, isActive: false, Ice.Mods.Categories.SuperInfection.UnlockAllGadgets),
		new ButtonHandler.Button("Unlock Full Tree", Category.Gamemode, isToggle: false, isActive: false, Ice.Mods.Categories.SuperInfection.UnlockFullTechTree),
		new ButtonHandler.Button("No Blaster Cooldown", Category.Gamemode, isToggle: true, isActive: false, delegate
		{
			IEnumerator<SIGadgetBlaster> enumerator = (from x in Ice.Mods.Categories.SuperInfection.GetActiveLocalPlayerGadgets()
			...
			if (enumerator.MoveNext())
			{
				do
				{
					...
					Ice.Mods.Categories.SuperInfection.RemoveBlasterCooldown(current);
				}
		...
		{
			IEnumerator<SIGadgetChargeBlaster> enumerator = (from x in Ice.Mods.Categories.SuperInfection.GetActiveLocalPlayerGadgets()
			...
			if (enumerator.MoveNext())
			{
				do
				{
					...
					Ice.Mods.Categories.SuperInfection.MaxChargeAlways(current);
				}
				while (enumerator.MoveNext());
			}
		}),
		new ButtonHandler.Button("Fast Charge", Category.Gamemode, isToggle: true, isActive: false, delegate
		{
			...
			if (enumerator.MoveNext())
			{
				...
				{
					SIGadgetChargeBlaster current = enumerator.Current;
					Ice.Mods.Categories.SuperInfection.FastCharge(current);
				}
				while (enumerator.MoveNext());
			}
		}),
		...
		{
			IEnumerator<SIGadgetDashYoyo> enumerator = (from x in Ice.Mods.Categories.SuperInfection.GetActiveLocalPlayerGadgets()
			...
			if (enumerator.MoveNext())
			{
				do
				{
					...
					Ice.Mods.Categories.SuperInfection.RemoveDashCooldown(current);
				}
				while (enumerator.MoveNext());
			}
		}),
		new ButtonHandler.Button("Clear Exclusion Zones", Category.Gamemode, isToggle: false, isActive: false, Ice.Mods.Categories.SuperInfection.ClearAllExclusionZones),
